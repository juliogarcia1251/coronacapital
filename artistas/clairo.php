...
$sql = "SELECT imagen FROM artistas WHERE nombre = 'clairo' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title>Clairo - Festival Corona Capital</title>
...
<body>
    ...
    <main class="contenedor artista">
        ...
        <div class="info-artista">
            ...
            <h2>Clairo</h2>
            <p>
                Clairo, cuyo nombre real es Claire Cottrill, es una cantante y compositora estadounidense que se hizo conocida en 2017 con su sencillo "Pretty Girl". En 2019, lanzó su álbum debut Immunity, que combinó pop alternativo e indie con letras personales y emotivas. Su segundo disco, Sling (2021), exploró sonidos más acústicos y folk, marcando una transición hacia una sonoridad más orgánica. En 2024, presentó Charm, un álbum influenciado por el soul y el pop de los años 70, con producción analógica y arreglos más sofisticados. Este trabajo refleja su madurez artística y su deseo de experimentar con nuevas texturas sonoras. 
            </p>
    
            <!-- Redes sociales -->
            <div class="redes-sociales">
                <a href="https://www.facebook.com/clairecottrill2" target="_blank"> <svg
                ...
                <a href="https://twitter.com/clairo" target="_blank">
                ...
                <a href="https://www.instagram.com/clairo" target="_blank">
                ...
                <a href="https://www.youtube.com/clairo" target="_blank">
                ...
                <a href="https://open.spotify.com/intl-es/artist/3l0CmX0FuQjFxr8SK7Vqag" target="_blank">
