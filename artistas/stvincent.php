...
$sql = "SELECT imagen FROM artistas WHERE nombre = 'stvincent' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title>St. Vincent - Festival Corona Capital</title>
...
<body>
    ...
    <header class="header">
        <div class="contenedor contenido-header">
            <h1><a href="../index.html">Corona Capital</a></h1>
    ...
    <main class="contenedor artista">
        ...
        <div class="info-artista">
            ...
            <h2>St. Vincent</h2>
            <p>
                St. Vincent, el nombre artístico de Annie Clark, es una cantante, compositora y productora estadounidense, conocida por su estilo único que fusiona el indie rock, la electrónica experimental y el art pop. Inició su carrera como guitarrista de otras bandas antes de lanzarse como solista en 2007. Con el paso de los años, ha ganado notoriedad por sus innovadores discos, destacando por su técnica de guitarra precisa y su enfoque experimental en la producción. Su último trabajo, All Born Screaming (2024), es un álbum profundamente introspectivo que mezcla sonidos del rock clásico con la electrónica industrial y el pop experimental.             
            </p>
    
            <!-- Redes sociales -->
            <div class="redes-sociales">
                <a href="https://www.facebook.com/st.vincent" target="_blank"> <svg
                ...
                <a href="https://twitter.com/st_vincent" target="_blank">
                ...
                <a href="https://www.instagram.com/st_vincent" target="_blank">
                ...
                <a href="https://www.youtube.com/@st.vincent" target="_blank">
                ...
                <a href="https://open.spotify.com/intl-es/artist/7bcbShaqKdcyjnmv4Ix8j6" target="_blank">
