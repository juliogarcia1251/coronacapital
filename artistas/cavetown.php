...
$sql = "SELECT imagen FROM artistas WHERE nombre = 'cavetown' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title>Cavetown - Festival Corona Capital</title>
...
<body>
    ...
    <main class="contenedor artista">
        ...
        <div class="info-artista">
            ...
            <h2>Cavetown</h2>
            <p>
                Cavetown es el proyecto de Robin Skinner, un cantante y productor británico que se hizo conocido por su estilo indie, lo-fi y sus letras vulnerables. Desde sus inicios en 2013, ha logrado una base de seguidores leales gracias a su enfoque íntimo y emotivo. En 2024, lanzó su álbum "homerun", que mantiene su característico sonido suave pero introduce nuevas capas de madurez y complejidad en sus composiciones, con temas que abordan la autoaceptación y las dificultades emocionales.                
            </p>
    
            <!-- Redes sociales -->
            <div class="redes-sociales">
                <a href="https://www.facebook.com/cavetown" target="_blank"> <svg
                ...
                <a href="https://twitter.com/cavetown" target="_blank">
                ...
                <a href="https://www.instagram.com/lemon.socks" target="_blank">
                ...
                <a href="https://www.youtube.com/cavetown" target="_blank">
                ...
                <a href="https://open.spotify.com/intl-es/artist/2hR4h1Cao2ueuI7Cx9c7V8" target="_blank">
