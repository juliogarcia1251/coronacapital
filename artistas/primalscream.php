...
$sql = "SELECT imagen FROM artistas WHERE nombre = 'primalscream' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title>Primal Scream - Festival Corona Capital</title>
...
<body>
    ...
    <main class="contenedor artista">
        ...
        <div class="info-artista">
            ...
            <h2>Primal Scream</h2>
            <p>
                Primal Scream es una banda británica formada en 1982, conocida por su mezcla de rock, electrónica, dance y música experimental. Su álbum más famoso, Screamadelica (1991), fusionó rock y house, convirtiéndose en un hito dentro de la música británica. A lo largo de su carrera, el grupo ha experimentado transformaciones sonoras, explorando géneros como el punk, el funk y el rock psicodélico. Su último trabajo, Come Ahead (2024), ofrece una fusión de funk y música cinematográfica, con letras personales de Bobby Gillespie.             
            </p>
    
            <!-- Redes sociales -->
            <div class="redes-sociales">
                <a href="https://www.facebook.com/primalscreamofficial" target="_blank"> <svg
                ...
                <a href="https://twitter.com/screamofficial" target="_blank">
                ...
                <a href="https://www.instagram.com/primalscreamofficial" target="_blank">
                ...
                <a href="https://www.youtube.com/primalscreamofficial" target="_blank">
                ...
                <a href="https://open.spotify.com/intl-es/artist/3wury2nd8idV4GecUg5xze" target="_blank">
