...
$sql = "SELECT imagen FROM artistas WHERE nombre = 'crumb' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title>Crumb - Festival Corona Capital</title>
...
<body>
    ...
    <main class="contenedor artista">
        ...
        <div class="info-artista">
            ...
            <h2>Crumb</h2>
            <p>
                Crumb es una banda estadounidense de Brooklyn que se destaca por su mezcla de psicodelia, indie rock y jazz experimental. Desde su formación en 2016, han explorado una sonoridad relajada y atmosférica, con un enfoque en la creación de paisajes sonoros complejos y envolventes. Su álbum más reciente, "AMAMA" (2024), expande aún más su paleta sonora, incorporando influencias del funk y el soul, mientras mantienen una atmósfera melancólica y experimental que caracteriza su estilo único.                
            </p>
    
            <!-- Redes sociales -->
            <div class="redes-sociales">
                <a href="https://www.facebook.com/thecrumbband" target="_blank"> <svg
                ...
                <a href="https://twitter.com/crumbtheband" target="_blank">
                ...
                <a href="https://www.instagram.com/some_crumb" target="_blank">
                ...
                <a href="https://www.youtube.com/crumbtheband" target="_blank">
                ...
                <a href="https://open.spotify.com/intl-es/artist/4kSGbjWGxTchKpIxXPJv0B" target="_blank">
