...
$sql = "SELECT imagen FROM artistas WHERE nombre = 'nothing' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title>Nothing But Thieves - Festival Corona Capital</title>
...
<body>
    ...
    <main class="contenedor artista">
        ...
        <div class="info-artista">
            <br>
            <h2>Nothing But Thieves</h2>
            <p>
                Nothing But Thieves es una banda británica de rock alternativo formada en 2012. Conocidos por su capacidad para fusionar elementos de rock clásico con toques electrónicos, han logrado gran éxito tanto en Reino Unido como en el resto del mundo. Su discografía incluye varios álbumes aclamados, y su trabajo más reciente, "Dead Club City" (2023), marca una evolución hacia un sonido más oscuro y experimental, incorporando temas introspectivos y una producción cuidada que refleja su madurez musical.                
            </p>
    
            <!-- Redes sociales -->
            <div class="redes-sociales">
                <a href="https://www.facebook.com/nothingbutthieves" target="_blank"> <svg
                ...
                <a href="https://twitter.com/nbthieves" target="_blank">
                ...
                <a href="https://www.instagram.com/nothingbutthieves" target="_blank">
                ...
                <a href="https://www.youtube.com/nothingbutthieves" target="_blank">
                ...
                <a href="https://open.spotify.com/intl-es/artist/1kDGbuxWknIKx4FlgWxiSp" target="_blank">
