...
$sql = "SELECT imagen FROM artistas WHERE nombre = 'beck' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title>Beck - Festival Corona Capital</title>
...
<body>
    ...
    <main class="contenedor artista">
        ...
        <div class="info-artista">
            ...
            <h2>Beck</h2>
            <p>
                Beck Hansen, un pionero de la música alternativa, es conocido por su habilidad para mezclar géneros como folk, rock, hip-hop y electrónica. Desde su icónica "Loser" en los años 90 hasta álbumes innovadores como "Odelay" y "Morning Phase", ha demostrado una reinvención constante. Su disco más reciente, "Hyperspace", lanzado en 2019, presenta un sonido electrónico introspectivo con colaboraciones de Pharrell Williams, consolidando su estatus como uno de los artistas más versátiles de su generación.                
            </p>
    
            <!-- Redes sociales -->
            <div class="redes-sociales">
                <a href="https://www.facebook.com/beck" target="_blank"> <svg
                ...
                <a href="https://twitter.com/beck" target="_blank">
                ...
                <a href="https://www.instagram.com/beck" target="_blank">
                ...
                <a href="https://www.youtube.com/beck" target="_blank">
                ...
                <a href="https://open.spotify.com/intl-es/artist/3vbKDsSS70ZX9D2OcvbZmS" target="_blank">
